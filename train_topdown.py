...
def train(opt):
    ...
    opt.vocab_size = loader.vocab_size  # 10369
    ...
    try:
        while True:
            ...
            data = loader.get_batch(
                'train')  # att_feats->[80,54,2048],  att_masks->[80, 54], fc_feats->[80, 2048], labels->[80, 18],  masks->[80, 18]
            ...
            fc_feats, att_feats, labels, masks, att_masks = tmp  # fc_feats->[80, 2048], att_feats->[80,54,2048], labels->[80, 18], masks->[80, 18], att_masks->[80, 54]
